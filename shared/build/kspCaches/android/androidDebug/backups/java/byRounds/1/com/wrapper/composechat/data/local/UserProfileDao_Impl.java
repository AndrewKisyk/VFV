...
public final class UserProfileDao_Impl implements UserProfileDao {
  ...
  public UserProfileDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserProfileEntity = new EntityInsertionAdapter<UserProfileEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `user_profile` (`id`,`age`,`sex`) VALUES (?,?,?)";
      }
  ...
  @Override
  public Object upsertProfile(final UserProfileEntity entity,
      ...
      public UserProfileEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new UserProfileEntity(_tmpId,_tmpAge,_tmpSex);
          } else {
            _result = null;
          }
          return _result;
